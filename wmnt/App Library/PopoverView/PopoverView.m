...
static CGFloat const kPopoverViewArrowHeight = 7.f;  ///< 箭头高度
...
@property (nonatomic, copy) HidePopoverView hidePopoverView;
#pragma mark - Data
...
#pragma mark - Setter
- (void)setPopoverViewHide:(HidePopoverView)hidePopoverView
{
    _hidePopoverView = hidePopoverView;
}
