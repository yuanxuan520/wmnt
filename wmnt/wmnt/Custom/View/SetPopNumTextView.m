...
@interface SetPopNumTextView()<UITextViewDelegate>
@property (nonatomic, copy) SetNumText setNumText;
//标题显示:
...
@implementation SetPopNumTextView
...
- (void)createView
{
    ...
    completionTextView = [[UIPlaceHolderTextView alloc] initWithFrame:CGRectMake(20,CGRectGetMaxY(titleLabel.frame)+10, CGRectGetWidth(showView.frame)-40,38)];
    completionTextView.textColor = [UIColor colorFromHexRGB:@"494949"];
    completionTextView.placeholder = @"请输入金额";
    ...
    completionTextView.keyboardType = UIKeyboardTypeNumberPad;
...
- (void)saveContent:(UIButton *)btn
{
    ...
    if (self.setNumText) {
        self.setNumText(self.completionTextView.text);
    }
    [self closeView];
